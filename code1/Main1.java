...
public class Main1 {
	...
	public static void retrieveInfoById(String deptId, String employeeId, String studentId) {
        Department department = departmentList.getInstance(deptId);
        Employee employee = employeeList.getInstance(employeeId);
        StudentCounselling counselling = studentCounsellingList.getInstance(studentId);
        StudentPerformance performance = studentPerformanceList.getInstance(studentId);
	...
	public static void retrieveStudentsAndEmployeesInDepartment(String deptId)
	{
        ...
        ArrayList<Employee> employees = employeeList.getListById(deptId);
	...
	public static void performDepartmentStats(String deptId) {
        ...
        int numberOfEmployees = employeeList.getListById(deptId).size();
