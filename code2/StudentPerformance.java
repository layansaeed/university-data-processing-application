...
public class StudentPerformance extends DBObject {
    ...
    public StudentPerformance(StudentPerformanceBuilder builder) {
        super(builder.getId());
        this.semester_name = builder.getSemesterName();
        this.paper_id = builder.getPaperId();
        this.paper_name = builder.getPaperName();
